...
private extension String {
    ...
    // MARK: Тут свойства добавленные в домашней работе

    static let allNamesIdentifier = "allNames"
}
...
final class MeowleSearchCatPage: BasePage {
    ...
    private lazy var allNamesButton = app.buttons[.allNamesIdentifier]
    ...
    // MARK: Тут методы добавленные в домашней работе
